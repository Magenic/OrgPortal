...
namespace OrgPortal
{
  ...
  public sealed partial class ItemPage : Page
  {
    ...
    private async void InstallApp(object sender, RoutedEventArgs e)
    {
      ...
      await Windows.Storage.FileIO.WriteLinesAsync(file, new string[] { "install", item.AppxUrl });
      await new Windows.UI.Popups.MessageDialog("Install request sent", "Install App").ShowAsync();
    }
  }
}